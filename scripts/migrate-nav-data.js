...
async function migrate() {
    ...
    for (const item of modules) {
        ...
        // UPSERT: 存在则更新，不存在则插入
        await connection.execute(`INSERT INTO nav_config (module, navData, version)
       VALUES (?, ?, 1)
       ON DUPLICATE KEY UPDATE navData = VALUES(navData), version = version + 1`, [item.module, jsonData]);
